...
public class ChannelWorkflowTests extends BaseTest {
	...
	String jsonCreateValidChannel = "{\"request\":{\"channel\":{\"name\":\"content\",\"description\":\"\",\"code\":\"org.ekstep.test\",\"contentFilter\":{\"filters\":{\"gradeLevel\":[\"Grade 3\"]}}}}}";
	String jsonContentClean = "{\"request\": {\"searchProperty\": \"name\",\"searchOperator\": \"startsWith\",\"searchString\": \"LP_FT_\"}}";
	String jsonCreateInValidChannel = "{\"request\":{\"Channel\":{\"name\":\"content\",\"description\":\"\",\"code\":\"org.ekstep.test\",\"contentFilter\":{\"filters\":{\"gradeLevel\":[\"Grade 3\"]}}}}}";	
