...
public class assesmentItemAPI extends BaseTest {
	...
	String jsonCreateAssessmentItemMTF = "{ \"request\": {\"assessment_item\": {  \"identifier\": \"ek.n.q933 - QA02\",  \"objectType\": \"AssessmentItem\", \"metadata\": {\"code\": \"ek.n.q933 - QA02\",\"name\": \"MTF Question 1 - QA02\",\"type\": \"mtf\",\"template\": \"mtf_template_3\",\"qlevel\": \"MEDIUM\",\"title\": \"ಕೊಟ್ಟಿರುವ ಸಂಖ್ಯೆಗಳನ್ನು ಇಳಿಕೆ ಕ್ರಮದಲ್ಲಿ ಜೋಡಿಸಿರಿ.\",\"question\":\"2080\",\"model\":{\"data0\":\"23450\",\"data1\":\"23540\"},\"lhs_options\": [{\"value\": {\"type\": \"image\", \"asset\": \"grey\"},\"index\": 0}],\"rhs_options\": [{\"value\": {\"type\": \"text\", \"asset\": \">\", \"font\": \"Verdana\", \"color\": \"white\",  \"fontsize\": \"1000\"}},{\"value\": {\"type\": \"text\", \"asset\": \"=\", \"font\": \"Verdana\", \"color\": \"white\",  \"fontsize\": \"1000\"}},{\"value\": {\"type\": \"text\", \"asset\": \"<\", \"font\": \"Verdana\", \"color\": \"white\",  \"fontsize\": \"1000\"},\"answer\": 0}],\"max_score\": 6,\"partial_scoring\": true,\"feedback\": \"\"}}}}";
	String jsonCreateInvalidAssessmentItemMTF = "{ \"request\": {\"assessment_item\": {  \"identifier\": \"ek.n.q933 - QA1\",  \"objectType\": \"AssessmentItem\", \"metadata\": {\"code\": \"ek.n.q933 - QA1\",\"name\": \"MTF Question 1 - QA1\",\"type\": \"mtf\",\"template\": \"mtf_template_3\",\"qlevel\": \"\",\"title\": \"ಕೊಟ್ಟಿರುವ ಸಂಖ್ಯೆಗಳನ್ನು ಇಳಿಕೆ ಕ್ರಮದಲ್ಲಿ ಜೋಡಿಸಿರಿ.\",\"question\":\"2080\",\"model\":{\"data0\":\"23450\",\"data1\":\"23540\"},\"lhs_options\": [{\"value\": {\"type\": \"image\", \"asset\": \"grey\"},\"index\": 0}],\"rhs_options\": [{\"value\": {\"type\": \"text\", \"asset\": \">\", \"font\": \"Verdana\", \"color\": \"white\",  \"fontsize\": \"1000\"}},{\"value\": {\"type\": \"text\", \"asset\": \"=\", \"font\": \"Verdana\", \"color\": \"white\",  \"fontsize\": \"1000\"}},{\"value\": {\"type\": \"text\", \"asset\": \"<\", \"font\": \"Verdana\", \"color\": \"white\",  \"fontsize\": \"1000\"},\"answer\": 0}],\"max_score\": 6,\"partial_scoring\": true,\"feedback\": \"\"}}}}";

	String jsonUpdateValidAssessment = "{\"request\":{\"assessment_item\": {\"identifier\": \"ek.n.q935 - QA6\",\"objectType\": \"AssessmentItem\",\"metadata\": {\"code\": \"ek.n.q935 - QA6\",\"name\": \"MCQ Question 2\",\"type\": \"mcq\",\"num_answers\": 1,\"template\": \"mcq_template_2\",\"qlevel\": \"MEDIUM\",\"owner\": \"username_1\",\"title\": \"ಈ ಚಿತ್ರದ ವಿಸ್ತೀರ್ಣವನ್ನು ಹಾಗೂ ಸುತ್ತಳತೆಯನ್ನು ಲೆಕ್ಕ ಮಾಡಿ.  ಸೂಕ್ತ ಉತ್ತರವನ್ನು ಆರಿಸಿರಿ.\",\"question\":\"ವಿಸ್ತೀರ್ಣ = ___________ ಚದರ ಸೆಂ.ಮೀ.             ಸುತ್ತಳತೆ= __________ ಚದರ ಸೆಂ.ಮೀ.\",\"model\":{\"img\":{\"type\":\"image\",\"asset\":\"perimeter\"},\"img2\":{\"type\":\"image\",\"asset\":\"smallSquare\"},\"subtext\":\"(= 1  ಚದರ ಸೆಂ.ಮೀ)\"},\"options\": [{\"value\": {\"type\": \"text\", \"asset\": \"12&10\", \"font\": \"Verdana\", \"color\": \"white\",  \"fontsize\": \"240\"}},{\"value\": {\"type\": \"text\", \"asset\": \"14&7\", \"font\": \"Verdana\", \"color\": \"white\",  \"fontsize\": \"240\"}},	{\"value\": {\"type\": \"text\", \"asset\": \"16&8\", \"font\": \"Verdana\", \"color\": \"white\",  \"fontsize\": \"240\"}},{\"value\": {\"type\": \"text\", \"asset\": \"12&7\", \"font\": \"Verdana\", \"color\": \"white\",  \"fontsize\": \"240\"},\"score\":1}],\"max_score\": 1,\"partial_scoring\": false,\"feedback\": \"\"},\"outRelations\": [{\"endNodeId\": \"Num:C1:SC1\",\"relationType\": \"associatedTo\"}]}}}";
	...
	public void updateValidAssessmentExpectSuccess200() {
		...
		when().
			patch("assessmentitem/ek.n.q932 - QA07").
		then().
			log().all().
			spec(get200ResponseSpec());
	}
	...
	public void updateInvalidAssessmentExpect400() {
		...
		with().
			contentType("application/json").
		when().
			patch("assessmentitem/ek.n.q932 - QA7678789").
		then().
			log().all().
			spec(get400ResponseSpec());
	}
	...
	public void getValidAssessmentItemExpectSuccess200() {
		...
		given().
			spec(getRequestSpec(contentType, validuserId)).
		when().
			get("assessmentitem/ek.n.q932 - QA21").
		then().
			log().all().
			spec(get200ResponseSpec());
	}
	...
	public void getInvalidAssessmentItemExpect400() {
		...
		given().
			spec(getRequestSpec(contentType, validuserId)).
		when().
			get("assessmentitem/ek.n.q932 - QA234").
		then().
			log().all().
			spec(get400ResponseSpec());
	}
	...
	public void deleteValidAssessmentExpectSuccess200() {
		...
		given().
			spec(getRequestSpec(contentType, validuserId)).
		when().
			delete("assessmentitem/ek.n.q932 - QA2").
		then().
			log().all().
			spec(get200ResponseSpec());
	}
