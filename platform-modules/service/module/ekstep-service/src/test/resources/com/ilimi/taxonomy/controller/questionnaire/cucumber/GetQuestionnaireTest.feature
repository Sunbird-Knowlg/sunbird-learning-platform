...
#    When Get questionnaire when Taxonomy id is numeracy and questionnaire id is numeracy_401
...
#  	When Get questionnaire when Taxonomy id is empty and questionnaire id is numeracy_401
...
#  	When Get questionnaire when Taxonomy id is absent and questionnaire id is numeracy_401
#  	Then return status of get questionnaire is failed and response code is 400
