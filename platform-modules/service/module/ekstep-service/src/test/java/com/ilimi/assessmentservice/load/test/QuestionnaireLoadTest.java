...
public class QuestionnaireLoadTest extends AbstractTestNGSpringContextTests{
    ...
    public void calculateAVG(){
		System.out.println();
    	System.out.println("Avg time taken by create Questionnaire API for " +IC+ " Threads :" + sum[0]/(float)(1000*IC) + " seconds");
    	System.out.println("Avg time taken by update Questionnaire API for " +IC+ " Threads :" + sum[1]/(float)(1000*IC) + " seconds");
    	System.out.println("Avg time taken by get Questionnaire API for " +IC+ " Threads    :" + sum[2]/(float)(1000*IC) + " seconds");
    	System.out.println("Avg time taken by delete Questionnaire API for " +IC+ " Threads :" + sum[3]/(float)(1000*IC) + " seconds");
    	System.out.println("Avg time taken by deliver Questionnaire API for " +IC+ " Threads :" + sum[4]/(float)(1000*IC) + " seconds");
    	System.out.println();
    }
    
    @Test(threadPoolSize = PS, invocationCount = IC , dependsOnMethods = "createQuestions")
