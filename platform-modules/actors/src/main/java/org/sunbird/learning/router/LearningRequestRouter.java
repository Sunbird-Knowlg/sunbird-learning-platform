...
public class LearningRequestRouter extends UntypedActor {
	...
	private void initActorPool() {
		...
		TelemetryManager.log("LearningRequestRouter: initActorPool:: Before adding actors to pool" );
		...
		TelemetryManager.log("LearningRequestRouter: initActorPool:: After adding actors to pool" );
	}
	...
	private ActorRef getActorFromPool(Request request) {
		...
		TelemetryManager.log("LearningRequestRouter: getActorFromPool:: Actor ref: " + ref );
		return ref;
	}
