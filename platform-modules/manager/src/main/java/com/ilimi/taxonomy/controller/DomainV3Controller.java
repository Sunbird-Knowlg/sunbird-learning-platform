...
@Controller
@RequestMapping("/v3/public/domains")
public class DomainV3Controller extends BaseController {

    private static LogHelper LOGGER = LogHelper.getInstance(DomainV3Controller.class.getName());

    @Autowired
    private ITaxonomyManager taxonomyManager;

    @RequestMapping(value = "read/graph/{id:.+}", method = RequestMethod.GET)
    @ResponseBody
