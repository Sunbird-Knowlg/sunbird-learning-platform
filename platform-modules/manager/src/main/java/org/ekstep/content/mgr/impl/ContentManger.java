...
import org.ekstep.content.mgr.impl.operation.content.DeleteCacheOperation;
...
public class ContentManger {
    ...
    private final DeleteCacheOperation deleteCacheOperation = new DeleteCacheOperation();
