...
public class ReadCopyFrameworkTest extends TestSetup {
	...
	private static void createTestIndex() throws Exception {
		...
		String settings = "{\"settings\":{\"index\":{\"index\":\"" + COMPOSITE_SEARCH_INDEX + "\",\"type\":\""
				+ COMPOSITE_SEARCH_INDEX_TYPE
		...
		String mappings = "{\"" + COMPOSITE_SEARCH_INDEX_TYPE
