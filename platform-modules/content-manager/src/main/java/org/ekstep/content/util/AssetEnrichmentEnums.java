...
public enum AssetEnrichmentEnums {
    ...
    iteration, FAILED, video, processingError, Failed, PROCESSING_ERROR, artifactUrl, mimeType, channel, pkgVersion, streamingUrl, ERR_NODE_CANT_BE_NULL;
}
