...
object TelemetryDataConsolidator extends Application {
    ...
    def main(i: String, o: Option[String], l: Option[String], p: Option[String], outputDir: String) {
        AppConf.init();
        val t1 = System.currentTimeMillis;
        TelemetryDataConsolidatorModel.compute(i, o, outputDir, l.getOrElse("local"), p.getOrElse(AppConf.getConfig("default.parallelization")).toInt)
