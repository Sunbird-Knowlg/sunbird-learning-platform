...
import com.ilimi.analytics.enums.AnalyticsErrorCodes;
...
public abstract class BaseController {
	...
	protected Response getErrorResponse(Exception e) {
		...
		if (e instanceof MiddlewareException) {
			...
			resStatus.setErr(AnalyticsErrorCodes.SYSTEM_ERROR.name());
		}
	...
	@SuppressWarnings("unchecked")
    protected Map<String, Object> getSearchParams(Map<String, Object> requestMap) {
