...
public class LanguageDictionaryTest {
	...
	public void createWordTest() throws JsonParseException,
			JsonMappingException, IOException {
		String contentString = "{\"request\":{\"words\":[{\"identifier\":\"en_w_708\",\"lemma\":\"test_create_word_708\",\"difficultyLevel\":\"Easy\",\"synonyms\":[{\"identifier\":\"108242255\"},{\"identifier\":\"201339774\"},{\"identifier\":\"202708688\",\"key1\":\"value1\",\"key2\":\"value2\"},{\"gloss\":\"newsynonym\",\"words\":[\"newtestword3\",\"newtestword4\",\"newtestword431\",\"newtestword433\"]}],\"antonyms\":[{\"name\":\"newtestword3\"},{\"name\":\"newtestword431\"}],\"tags\":[\"English\",\"API\"]}]}}";
	...
	public void updateWordTest() throws JsonParseException,
			JsonMappingException, IOException {
		String contentString = "{\"request\":{\"word\":{\"lemma\":\"test_create_word_707\",\"synonyms\":[{\"identifier\":\"108242255\"},{\"identifier\":\"201339774\"},{\"identifier\":\"201339774\"},{\"identifier\":\"202707688\",\"key1\":\"value1\",\"key2\":\"value2\"},{\"gloss\":\"newsynonym\",\"words\":[\"newtestword3\",\"newtestword4\",\"newtestword431\",\"newtestword433\"]}],\"antonyms\":[{\"name\":\"newtestword3\"},{\"name\":\"newtestword431\"}],\"pronunciations\":[\"https://s3-ap-southeast-1.amazonaws.com/ekstep-public/language_assets/andhera.mp3\"],\"pictures\":[\"https://s3-ap-southeast-1.amazonaws.com/ekstep-public/language_assets/dark.jpg\"]}}}";
		String expectedResult = "\"en_w_707\"";
		MockMvc mockMvc;
		mockMvc = MockMvcBuilders.webAppContextSetup(context).build();
		String path = "/v1/language/dictionary/word/" + TEST_CREATE_LANGUAGE
	...
	public void getWord() throws JsonParseException, JsonMappingException,
		...
		wordMap.put("language", TEST_LANGUAGE);
		String resultString = mapper.writeValueAsString(wordMap);
		// Assert.assertEquals(expectedResult, resultString);
	}
	...
	public void getSynonyms() throws JsonParseException, JsonMappingException,
			IOException {
		String expectedResult = "[{\"identifier\":\"en_w_707\",\"difficultyLevel\":\"Easy\",\"words\":[],\"lemma\":\"test_create_word_707\",\"status\":\"Live\"}]";
		MockMvc mockMvc;
		mockMvc = MockMvcBuilders.webAppContextSetup(context).build();
		String path = "/v1/language/dictionary/word/" + TEST_LANGUAGE
				+ "/synonym/202707688";
		...
		Assert.assertEquals("successful", response.getParams().getStatus());
		Map<String, Object> result = response.getResult();
		List<Map<String, Object>> synonyms = (List<Map<String, Object>>) result
				.get("synonyms");
		String resultString = mapper.writeValueAsString(synonyms);
		Assert.assertEquals(expectedResult, resultString);
	}
	...
	public void getWords() throws JsonParseException, JsonMappingException,
		...
		Map<String, Object> listTest = mapper.readValue(expectedResult,
				new TypeReference<Map<String, Object>>() {
				});
		...
		Assert.assertEquals("successful", response.getParams().getStatus());
		/*
		 * Map<String, Object> result = response.getResult(); List words =
		 * (List<Map<String, Object>>) result .get("words"); for (Object wordMap
		 * : words) { Map<String, Object> wordMapTemp = (Map<String, Object>)
		 * wordMap; wordMapTemp.put("lastUpdatedOn", "test");
		 * wordMapTemp.put("createdOn", "test"); wordMapTemp.put("language",
		 * TEST_LANGUAGE); } result = new HashMap<String, Object>();
		 * result.put("words", words); String resultString =
		 * mapper.writeValueAsString(words); List resWords =(List)
		 * listTest.get("words"); if(resWords.equals(words)){
		 * System.out.println("True"); } Assert.assertEquals(result, listTest);
		 */
	}
