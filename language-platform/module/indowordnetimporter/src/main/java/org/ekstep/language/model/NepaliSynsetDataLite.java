...
public class NepaliSynsetDataLite implements LanguageSynsetDataLite {
	...
	public NepaliSynsetDataLite() {
		super();
	}

	public NepaliSynsetDataLite(int synset_id, byte[] gloss, String category) {
		super();
	...
	public boolean equals(Object o) {
		if (o == null)
			return false;
		if (!(o instanceof NepaliSynsetDataLite))
			return false;

		NepaliSynsetDataLite other = (NepaliSynsetDataLite) o;
