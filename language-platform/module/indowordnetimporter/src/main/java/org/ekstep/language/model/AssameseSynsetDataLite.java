...
public class AssameseSynsetDataLite implements LanguageSynsetDataLite {
	...
	public AssameseSynsetDataLite(int synset_id, byte[] gloss, String category) {
		super();
	...
	public boolean equals(Object o) {
		if (o == null)
			return false;
		if (!(o instanceof AssameseSynsetDataLite))
			return false;

		AssameseSynsetDataLite other = (AssameseSynsetDataLite) o;
