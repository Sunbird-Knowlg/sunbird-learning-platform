...
public class BodoSynsetDataLite implements LanguageSynsetDataLite {
	...
	public BodoSynsetDataLite() {
		super();
	}

	public BodoSynsetDataLite(int synset_id, byte[] gloss, String category) {
		super();
	...
	public boolean equals(Object o) {
		if (o == null)
			return false;
		if (!(o instanceof BodoSynsetDataLite))
			return false;

		BodoSynsetDataLite other = (BodoSynsetDataLite) o;
