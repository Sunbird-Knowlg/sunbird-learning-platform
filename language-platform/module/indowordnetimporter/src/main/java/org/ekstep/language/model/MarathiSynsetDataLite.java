...
public class MarathiSynsetDataLite implements LanguageSynsetDataLite {
	...
	public MarathiSynsetDataLite() {
		super();
	}

	public MarathiSynsetDataLite(int synset_id, byte[] gloss, String category) {
		super();
	...
	public boolean equals(Object o) {
		if (o == null)
			return false;
		if (!(o instanceof MarathiSynsetDataLite))
			return false;

		MarathiSynsetDataLite other = (MarathiSynsetDataLite) o;
