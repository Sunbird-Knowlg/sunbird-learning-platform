...
public class KonkaniSynsetDataLite implements LanguageSynsetDataLite {
	...
	public KonkaniSynsetDataLite() {
		super();
	}

	public KonkaniSynsetDataLite(int synset_id, byte[] gloss, String category) {
		super();
	...
	public boolean equals(Object o) {
		if (o == null)
			return false;
		if (!(o instanceof KonkaniSynsetDataLite))
			return false;

		KonkaniSynsetDataLite other = (KonkaniSynsetDataLite) o;
