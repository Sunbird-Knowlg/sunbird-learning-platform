...
public class HindiSynsetDataLite implements LanguageSynsetDataLite {
	...
	public HindiSynsetDataLite() {
		super();
	}

	public HindiSynsetDataLite(int synset_id, byte[] gloss, String category) {
		super();
	...
	public boolean equals(Object o) {
		if (o == null)
			return false;
		if (!(o instanceof HindiSynsetDataLite))
			return false;

		HindiSynsetDataLite other = (HindiSynsetDataLite) o;
