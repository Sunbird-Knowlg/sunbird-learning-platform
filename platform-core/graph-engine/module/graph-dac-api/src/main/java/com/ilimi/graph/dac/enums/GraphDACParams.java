...
public enum GraphDACParams {
    ...
    graphId, identifier, key, newValue, status, adedTags, RETIRED, task_id, TAG, TAG_NAME, isoSymbol, type, unicode, properties, userId, requestId, addedRelations, removedRelations, label, altIsoSymbol, member;
}
