...
public enum GraphDACParams {
    ...
    graphId, identifier, key, newValue, status, adedTags, RETIRED, task_id, TAG, createdOn, TAG_NAME, isoSymbol, type, unicode, properties, userId, requestId, addedRelations, removedRelations, label, altIsoSymbol, member, proxyNode, translationSet, versionKey, versionCheckMode, STALE_DATA_UPDATED, NODE_UPDATE_STATUS, lastUpdatedOn;
}
