...
//    public static final List<String> definitionMetadataKeys = Arrays.asList("INDEXABLE_METADATA_KEY", "NON_INDEXABLE_METADATA_KEY", "IN_RELATIONS_KEY", "OUT_RELATIONS_KEY");
    ...
    public OutputStream getData() throws Exception {
        ...
        for(Node node : nodes) {
            ...
            } else if(!SystemNodeTypes.DEFINITION_NODE.name().equals(node.getNodeType()) && !SystemNodeTypes.ROOT_NODE.name().equals(node.getNodeType())) {
