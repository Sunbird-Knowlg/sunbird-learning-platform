...
public class RegistrationControllerTest extends TestSetup{
	...
	String commandBodyJson = "{\"id\":null,\"name\":\"testCommand_" + rn + "\",\"apiId\":\"\",\"version\":\"\",\"description\":\"\",\"body\":\"\",\"type\":\"COMMAND\",\"cmdClass\":\"org.ekstep.orchestrator.interpreter.command.ConvertToGraphNode\",\"parameters\":[],\"actorPath\":{\"manager\":null,\"operation\":null,\"router\":null},\"requestPath\":{\"type\":null,\"url\":null,\"pathParams\":null,\"requestParams\":null,\"bodyParams\":null},\"async\":null}";
