...
if {$check_error} {
	...
	java::for {Node graph_node} $graph_nodes {
		...
		if {$license_null == 0} {
			...
			set isCCBy [$license_str equalsIgnoreCase "CC-BY 4.0 For details: https://creativecommons.org/licenses/by/4.0/legalcode"]
		}
		if {$license_null == 1 || $isCCBy != 1} {
			$metadata put "license" "CC-BY 4.0 For details: https://creativecommons.org/licenses/by/4.0/legalcode"
