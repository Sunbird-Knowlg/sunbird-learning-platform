...
import org.sunbird.sync.tool.mgr.RelationCacheSyncManager;
...
public class RelationCacheSyncCommand implements CommandMarker {
    ...
    public void syncRelationCache(
        ...
        if (StringUtils.equalsIgnoreCase("true", forAll)) {
            ...
            System.out.println("Generating relations sync events for collections with id: " + idList);
            relationCacheSyncManager.syncCollectionByIds(idList, verboseBool);
        } else {
