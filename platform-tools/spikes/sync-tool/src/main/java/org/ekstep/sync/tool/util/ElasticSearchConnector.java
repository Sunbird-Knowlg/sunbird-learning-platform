...
public class ElasticSearchConnector {
	...
	public void createIndexIfNotExist() throws IOException {
		...
		ElasticSearchUtil.addIndex(indexName, documentType, settings, mappings, ES_TYPE);
	}

	public void bulkImport(Map<String, Object> messages) throws Exception {
		ElasticSearchUtil.bulkIndexWithIndexId(indexName, documentType, messages, ES_TYPE);
	}
	
	public void bulkImportAutoID(List<Map<String, Object>> messages) throws Exception {
		ElasticSearchUtil.bulkIndexWithAutoGenerateIndexId(indexName, documentType, messages, ES_TYPE);
	}
}
