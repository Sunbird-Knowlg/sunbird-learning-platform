...
public class BaseService extends PlatformAPIManager {
    ...
    protected Response uploadAsset(String path, String id, String src) throws Exception {
        ...
        String url = cloudStoreManager.getcloudService(destStorageType).upload(cloudStoreManager.getContainerName(destStorageType), file.getAbsolutePath(), objectKey, Option.apply(false), Option
