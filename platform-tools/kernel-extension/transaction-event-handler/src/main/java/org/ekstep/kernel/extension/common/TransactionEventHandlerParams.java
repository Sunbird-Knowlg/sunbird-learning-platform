...
public enum TransactionEventHandlerParams {
    ...
    graphId, identifier, key, newValue, status, adedTags, RETIRED, task_id, TAG, TAG_NAME, isoSymbol, type, unicode, properties, userId, requestId, addedRelations, removedRelations, label, altIsoSymbol, member, proxyNode, translationSet, versionKey, versionCheckMode, STALE_DATA_UPDATED, NODE_UPDATE_STATUS, lastUpdatedOn, ON, MATCH, SET, request, MERGE, nodes, RETURN, keys, nodesCount, relationsCount, rootNode, nodeId, WHERE, indexProperties, startNodeId, endNodeId, relationType, startNodeIds, endNodeIds, collectionId, collection, indexProperty, taskId, input, getTags, searchCriteria, paramMap, traverser, cypherQuery, domain;
}
