...
object RestUtil {
  ...
  implicit val className = "org.sunbird.media.util.RestUtil"
  ...
  def get[T](apiURL: String, headers: Map[String, String])(implicit mf: Manifest[T]) = {
  ...
  def post[T](apiURL: String, headers: Map[String, String], body: String)(implicit mf: Manifest[T]) = {
  ...
  def patch[T](apiURL: String, headers: Map[String, String], body: String)(implicit mf: Manifest[T]) = {
