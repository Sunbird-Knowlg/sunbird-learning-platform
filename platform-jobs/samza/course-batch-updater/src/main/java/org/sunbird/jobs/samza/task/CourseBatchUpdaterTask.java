...
public class CourseBatchUpdaterTask extends BaseTask {
    ...
    private Boolean generate_certificate_enabled = Platform.config.hasPath("generate_certificate_enabled") ? Platform.config.getBoolean("generate_certificate_enabled") : true;
    ...
    public void executeCourseProgressBatch(MessageCollector collector) {
        ...
        if(generate_certificate_enabled && CollectionUtils.isNotEmpty(userCertificateEvents)) {
