...
public enum ObjectLifecycleParams {
result, content, domain, operationType, DELETE, transactionData, properties, status, nodeUniqueId, ItemSet, SET, objectType, nodeType, channel,
